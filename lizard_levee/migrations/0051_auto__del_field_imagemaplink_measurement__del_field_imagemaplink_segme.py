...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lizard_levee_imagemaplink', 'measurement_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ImageMapLink.measurement'
        db.add_column('lizard_levee_imagemaplink', 'measurement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_geodin.Measurement'], null=True, blank=True), keep_default=False)
