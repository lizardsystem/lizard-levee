...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMap.auto_geo_polygon'
        db.add_column('lizard_levee_imagemap', 'auto_geo_polygon', self.gf('django.db.models.fields.CharField')(default=u'270000,570000,280000,580000', max_length=200), keep_default=False)

        # Adding field 'ImageMap.auto_from_above'
        db.add_column('lizard_levee_imagemap', 'auto_from_above', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ImageMap.auto_geo_direction'
        db.add_column('lizard_levee_imagemap', 'auto_geo_direction', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'ImageMap.auto_scale_x'
        db.add_column('lizard_levee_imagemap', 'auto_scale_x', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Adding field 'ImageMap.auto_scale_y'
        db.add_column('lizard_levee_imagemap', 'auto_scale_y', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMap.auto_geo_polygon'
        db.delete_column('lizard_levee_imagemap', 'auto_geo_polygon')

        # Deleting field 'ImageMap.auto_from_above'
        db.delete_column('lizard_levee_imagemap', 'auto_from_above')

        # Deleting field 'ImageMap.auto_geo_direction'
        db.delete_column('lizard_levee_imagemap', 'auto_geo_direction')

        # Deleting field 'ImageMap.auto_scale_x'
        db.delete_column('lizard_levee_imagemap', 'auto_scale_x')

        # Deleting field 'ImageMap.auto_scale_y'
        db.delete_column('lizard_levee_imagemap', 'auto_scale_y')
    ...
    models = {
        ...
        'lizard_levee.imagemap': {
            ...
            'auto_geo_polygon': ('django.db.models.fields.CharField', [], {'default': "u'270000,570000,280000,580000'", 'max_length': '200'}),
