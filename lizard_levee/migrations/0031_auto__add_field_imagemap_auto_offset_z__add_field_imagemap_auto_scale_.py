...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMap.auto_offset_z'
        ...
        # Adding field 'ImageMap.auto_scale_z'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ImageMap.auto_offset_z'
        db.delete_column('lizard_levee_imagemap', 'auto_offset_z')

        # Deleting field 'ImageMap.auto_scale_z'
        db.delete_column('lizard_levee_imagemap', 'auto_scale_z')
    ...
    models = {
        ...
        'lizard_levee.imagemap': {
            ...
            'auto_offset_z': ('django.db.models.fields.FloatField', [], {'default': '2.0'}),
