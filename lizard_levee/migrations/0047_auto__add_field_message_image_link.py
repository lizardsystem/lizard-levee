...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.image_link'
        db.add_column('lizard_levee_message', 'image_link', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.image_link'
        db.delete_column('lizard_levee_message', 'image_link')
