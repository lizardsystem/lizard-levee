...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMap.auto_offset_x'
        db.add_column('lizard_levee_imagemap', 'auto_offset_x', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Adding field 'ImageMap.auto_offset_y'
        db.add_column('lizard_levee_imagemap', 'auto_offset_y', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMap.auto_offset_x'
        db.delete_column('lizard_levee_imagemap', 'auto_offset_x')

        # Deleting field 'ImageMap.auto_offset_y'
        db.delete_column('lizard_levee_imagemap', 'auto_offset_y')
    ...
    models = {
        ...
        'lizard_levee.imagemap': {
            ...
            'auto_admin_value': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
            ...
            'auto_offset_x': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
            'auto_offset_y': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
