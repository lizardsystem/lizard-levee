...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImageMapLink.identifier'
        db.delete_column('lizard_levee_imagemaplink', 'identifier')

        # Deleting field 'ImageMapLink.destination_url'
        db.delete_column('lizard_levee_imagemaplink', 'destination_url')

        # Adding field 'ImageMapLink.measurement'
        db.add_column('lizard_levee_imagemaplink', 'measurement', self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['lizard_geodin.Measurement']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ImageMapLink.identifier'
        db.add_column('lizard_levee_imagemaplink', 'identifier', self.gf('django.db.models.fields.CharField')(default='identifier', max_length=80), keep_default=False)

        # Adding field 'ImageMapLink.destination_url'
        db.add_column('lizard_levee_imagemaplink', 'destination_url', self.gf('django.db.models.fields.TextField')(default='http://google.com'), keep_default=False)
    ...
    models = {
        ...
        'lizard_levee.imagemaplink': {
            ...
            'measurement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_geodin.Measurement']"}),
