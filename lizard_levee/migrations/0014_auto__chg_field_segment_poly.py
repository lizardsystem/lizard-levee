...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Segment.poly'
        db.alter_column('lizard_levee_segment', 'poly', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Segment.poly'
        raise RuntimeError("Cannot reverse this migration. 'Segment.poly' and its values cannot be restored.")
