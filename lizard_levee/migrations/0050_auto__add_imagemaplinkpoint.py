...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImageMapLinkPoint'
        db.create_table('lizard_levee_imagemaplinkpoint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image_map_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_levee.ImageMapLink'])),
            ('point', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_geodin.Point'])),
            ('index', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal('lizard_levee', ['ImageMapLinkPoint'])


    def backwards(self, orm):
        
        # Deleting model 'ImageMapLinkPoint'
        db.delete_table('lizard_levee_imagemaplinkpoint')
    ...
    models = {
        ...
        'lizard_levee.imagemaplinkpoint': {
            'Meta': {'object_name': 'ImageMapLinkPoint'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
