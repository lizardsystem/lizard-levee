...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMap.image_scale'
        db.add_column('lizard_levee_imagemap', 'image_scale', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMap.image_scale'
        db.delete_column('lizard_levee_imagemap', 'image_scale')
