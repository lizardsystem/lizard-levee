...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMap.auto_grouping_size'
        db.add_column('lizard_levee_imagemap', 'auto_grouping_size', self.gf('django.db.models.fields.IntegerField')(default=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMap.auto_grouping_size'
        db.delete_column('lizard_levee_imagemap', 'auto_grouping_size')
