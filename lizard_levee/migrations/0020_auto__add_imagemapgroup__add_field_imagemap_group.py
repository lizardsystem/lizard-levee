...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImageMapGroup'
        db.create_table('lizard_levee_imagemapgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('lizard_levee', ['ImageMapGroup'])

        # Adding field 'ImageMap.group'
        db.add_column('lizard_levee_imagemap', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_levee.ImageMapGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ImageMapGroup'
        db.delete_table('lizard_levee_imagemapgroup')

        # Deleting field 'ImageMap.group'
        db.delete_column('lizard_levee_imagemap', 'group_id')
