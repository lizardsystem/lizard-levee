...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMapGroup.index'
        db.add_column('lizard_levee_imagemapgroup', 'index', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)

        # Adding field 'ImageMapLink.image_map_index'
        db.add_column('lizard_levee_imagemaplink', 'image_map_index', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMapGroup.index'
        db.delete_column('lizard_levee_imagemapgroup', 'index')

        # Deleting field 'ImageMapLink.image_map_index'
        db.delete_column('lizard_levee_imagemaplink', 'image_map_index')
