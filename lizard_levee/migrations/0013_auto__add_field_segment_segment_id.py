...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Segment.segment_id'
        db.add_column('lizard_levee_segment', 'segment_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Segment.segment_id'
        db.delete_column('lizard_levee_segment', 'segment_id')
