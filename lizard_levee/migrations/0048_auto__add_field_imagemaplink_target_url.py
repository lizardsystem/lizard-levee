...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMapLink.target_url'
        db.add_column('lizard_levee_imagemaplink', 'target_url', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMapLink.target_url'
        db.delete_column('lizard_levee_imagemaplink', 'target_url')
