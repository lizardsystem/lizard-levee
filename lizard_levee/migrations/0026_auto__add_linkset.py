...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_levee_linkset', (
        ...
        db.send_create_signal('lizard_levee', ['LinkSet'])

        # Adding M2M table for field links on 'LinkSet'
        db.create_table('lizard_levee_linkset_links', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('linkset', models.ForeignKey(orm['lizard_levee.linkset'], null=False)),
            ('link', models.ForeignKey(orm['lizard_levee.link'], null=False))
        ))
        db.create_unique('lizard_levee_linkset_links', ['linkset_id', 'link_id'])


    def backwards(self, orm):
        
        # Deleting model 'LinkSet'
        db.delete_table('lizard_levee_linkset')

        # Removing M2M table for field links on 'LinkSet'
        db.delete_table('lizard_levee_linkset_links')
    ...
    models = {
        ...
        'lizard_levee.imagemapgroup': {
            'Meta': {'ordering': "(u'index',)", 'object_name': 'ImageMapGroup'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
