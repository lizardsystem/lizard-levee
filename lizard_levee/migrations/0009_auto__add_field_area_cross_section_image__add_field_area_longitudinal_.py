...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.cross_section_image'
        db.add_column('lizard_levee_area', 'cross_section_image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Area.longitudinal_cross_section_image'
        db.add_column('lizard_levee_area', 'longitudinal_cross_section_image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Area.cross_section_image'
        db.delete_column('lizard_levee_area', 'cross_section_image')

        # Deleting field 'Area.longitudinal_cross_section_image'
        db.delete_column('lizard_levee_area', 'longitudinal_cross_section_image')
