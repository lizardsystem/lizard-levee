...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImageMapGeoPolygon'
        db.create_table('lizard_levee_imagemapgeopolygon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('geo_polygon', self.gf('django.db.models.fields.CharField')(default=u'270000,570000,270000,580000,280000,580000,280000,570000', max_length=200)),
        ))
        db.send_create_signal('lizard_levee', ['ImageMapGeoPolygon'])

        # Adding field 'ImageMap.auto_geo'
        db.add_column('lizard_levee_imagemap', 'auto_geo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_levee.ImageMapGeoPolygon'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ImageMapGeoPolygon'
        db.delete_table('lizard_levee_imagemapgeopolygon')

        # Deleting field 'ImageMap.auto_geo'
        db.delete_column('lizard_levee_imagemap', 'auto_geo_id')
    ...
    models = {
        ...
        'lizard_levee.imagemap': {
            ...
            'auto_geo_polygon': ('django.db.models.fields.CharField', [], {'default': "u'270000,570000,270000,580000,280000,580000,280000,570000'", 'max_length': '200'}),
        ...
        'lizard_levee.imagemaplink': {
            ...
            'point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_geodin.Point']", 'null': 'True', 'blank': 'True'}),
