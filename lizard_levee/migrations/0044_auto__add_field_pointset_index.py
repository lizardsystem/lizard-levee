...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PointSet.index'
        db.add_column('lizard_levee_pointset', 'index', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PointSet.index'
        db.delete_column('lizard_levee_pointset', 'index')
