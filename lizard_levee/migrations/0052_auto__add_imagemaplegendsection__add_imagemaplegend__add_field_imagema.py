...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImageMapLegendSection'
        db.create_table('lizard_levee_imagemaplegendsection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image_map_legend', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_levee.ImageMapLegend'])),
            ('value_lower', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('value_upper', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('html_color', self.gf('django.db.models.fields.CharField')(default=u'#ff0000', max_length=20)),
        ))
        db.send_create_signal('lizard_levee', ['ImageMapLegendSection'])

        # Adding model 'ImageMapLegend'
        db.create_table('lizard_levee_imagemaplegend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal('lizard_levee', ['ImageMapLegend'])

        # Adding field 'ImageMapLink.color_legend'
        db.add_column('lizard_levee_imagemaplink', 'color_legend', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_levee.ImageMapLegend'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ImageMapLegendSection'
        db.delete_table('lizard_levee_imagemaplegendsection')

        # Deleting model 'ImageMapLegend'
        db.delete_table('lizard_levee_imagemaplegend')

        # Deleting field 'ImageMapLink.color_legend'
        db.delete_column('lizard_levee_imagemaplink', 'color_legend_id')
    ...
    models = {
        ...
        'lizard_levee.imagemaplegend': {
            'Meta': {'object_name': 'ImageMapLegend'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        },
        'lizard_levee.imagemaplegendsection': {
            'Meta': {'object_name': 'ImageMapLegendSection'},
            'html_color': ('django.db.models.fields.CharField', [], {'default': "u'#ff0000'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_map_legend': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_levee.ImageMapLegend']"}),
            'value_lower': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'value_upper': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        'lizard_levee.imagemaplink': {
            'Meta': {'ordering': "(u'image_map', u'image_map_index', u'shape', u'coords')", 'object_name': 'ImageMapLink'},
            'color_legend': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_levee.ImageMapLegend']", 'null': 'True', 'blank': 'True'}),
            ...
            'ordered_points': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'ordered_points'", 'to': "orm['lizard_geodin.Point']", 'through': "orm['lizard_levee.ImageMapLinkPoint']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'target_outline_color': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'target_url': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'lizard_levee.imagemaplinkpoint': {
            'Meta': {'ordering': "(u'index', u'image_map_link', u'index')", 'object_name': 'ImageMapLinkPoint'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_map_link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_levee.ImageMapLink']"}),
            'index': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_geodin.Point']"})
        },
