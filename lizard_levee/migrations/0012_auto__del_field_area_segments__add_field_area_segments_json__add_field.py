...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.segments_json'
        db.add_column('lizard_levee_area', 'segments_json', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Adding field 'Segment.area'
        db.add_column('lizard_levee_segment', 'area', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'segmentsss', null=True, to=orm['lizard_levee.Area']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Area.segments_json'
        db.delete_column('lizard_levee_area', 'segments_json')

        # Deleting field 'Segment.area'
        db.delete_column('lizard_levee_segment', 'area_id')
    ...
    models = {
        'lizard_levee.area': {
            ...
            'segments_json': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'lizard_levee.segment': {
            ...
            'area': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'segmentsss'", 'null': 'True', 'to': "orm['lizard_levee.Area']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
