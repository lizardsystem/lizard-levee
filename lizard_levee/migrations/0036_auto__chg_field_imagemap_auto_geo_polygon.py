...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageMap.auto_geo_polygon'
        db.alter_column('lizard_levee_imagemap', 'auto_geo_polygon', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'ImageMap.auto_geo_polygon'
        db.alter_column('lizard_levee_imagemap', 'auto_geo_polygon', self.gf('django.db.models.fields.CharField')(max_length=200))
