...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMapLink.target_outline_color'
        db.add_column('lizard_levee_imagemaplink', 'target_outline_color', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMapLink.target_outline_color'
        db.delete_column('lizard_levee_imagemaplink', 'target_outline_color')
