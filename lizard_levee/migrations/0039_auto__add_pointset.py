...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_levee_pointset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('width', self.gf('django.db.models.fields.IntegerField')(default=500)),
            ('height', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal('lizard_levee', ['PointSet'])

        # Adding M2M table for field points on 'PointSet'
        db.create_table('lizard_levee_pointset_points', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pointset', models.ForeignKey(orm['lizard_levee.pointset'], null=False)),
            ('point', models.ForeignKey(orm['lizard_geodin.point'], null=False))
        ))
        db.create_unique('lizard_levee_pointset_points', ['pointset_id', 'point_id'])


    def backwards(self, orm):
        
        # Deleting model 'PointSet'
        db.delete_table('lizard_levee_pointset')

        # Removing M2M table for field points on 'PointSet'
        db.delete_table('lizard_levee_pointset_points')
