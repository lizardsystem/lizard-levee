...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageMapLink.destination_url'
        db.alter_column('lizard_levee_imagemaplink', 'destination_url', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'ImageMapLink.destination_url'
        db.alter_column('lizard_levee_imagemaplink', 'destination_url', self.gf('django.db.models.fields.CharField')(max_length=200))
