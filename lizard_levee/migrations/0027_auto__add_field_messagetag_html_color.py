...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageTag.html_color'
        db.add_column('lizard_levee_messagetag', 'html_color', self.gf('django.db.models.fields.CharField')(default=u'#000000', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageTag.html_color'
        db.delete_column('lizard_levee_messagetag', 'html_color')
    ...
    models = {
        ...
        'lizard_levee.messagetag': {
            ...
            'html_color': ('django.db.models.fields.CharField', [], {'default': "u'#000000'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
