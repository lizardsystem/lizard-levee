...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Segment.risk'
        db.add_column('lizard_levee_segment', 'risk', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Segment.risk'
        db.delete_column('lizard_levee_segment', 'risk')
