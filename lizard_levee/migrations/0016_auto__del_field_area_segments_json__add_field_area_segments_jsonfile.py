...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.segments_jsonfile'
        db.add_column('lizard_levee_area', 'segments_jsonfile', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Area.segments_jsonfile'
        db.delete_column('lizard_levee_area', 'segments_jsonfile')
