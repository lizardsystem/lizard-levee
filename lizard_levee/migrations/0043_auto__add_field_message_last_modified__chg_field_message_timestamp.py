...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lizard_levee_message', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 14, 9, 21, 22, 151598), blank=True), keep_default=False)

        # Changing field 'Message.timestamp'
        db.alter_column('lizard_levee_message', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Message.last_modified'
        db.delete_column('lizard_levee_message', 'last_modified')

        # Changing field 'Message.timestamp'
        db.alter_column('lizard_levee_message', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 14, 9, 21, 51, 39644)))
