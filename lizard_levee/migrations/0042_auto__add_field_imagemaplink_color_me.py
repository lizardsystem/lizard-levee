...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMapLink.color_me'
        db.add_column('lizard_levee_imagemaplink', 'color_me', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMapLink.color_me'
        db.delete_column('lizard_levee_imagemaplink', 'color_me')
